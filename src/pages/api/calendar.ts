...
import { cicloLectivoCourseFilter, cicloLectivoOptionalCourseFilter, parseCicloLectivoParam } from '../../server/ciclo-lectivo';
...
function filters(url: URL, user: User) {
  return {
    ...
    ciclo_lectivo: parseCicloLectivoParam(url.searchParams.get('ciclo')),
